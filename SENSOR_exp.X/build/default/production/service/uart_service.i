...
// get/set PIR aliases
# 148 "service/../mcc_generated_files/pin_manager.h"
// get/set LED aliases
# 175 "service/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 187 "service/../mcc_generated_files/pin_manager.h"
...
# 1 "service/../mcc_generated_files/memory.h" 1
# 99 "service/../mcc_generated_files/memory.h"
uint16_t FLASH_ReadWord(uint16_t flashAddr);
# 128 "service/../mcc_generated_files/memory.h"
void FLASH_WriteWord(uint16_t flashAddr, uint16_t *ramBuf, uint16_t word);
# 164 "service/../mcc_generated_files/memory.h"
int8_t FLASH_WriteBlock(uint16_t writeAddr, uint16_t *flashWordArray);
# 189 "service/../mcc_generated_files/memory.h"
...
void UART_Init()
{
    TRISAbits.TRISA2 = 0; // Set TX pin as output
    LATAbits.LATA2 = 1; // Idle state is 1
}
void UART_SendChar(char data)
{
    ...
    // Start bit (0)
    LATAbits.LATA2 = 0;
    _delay((unsigned long)(((1000000 / 9600) // in microseconds)*(2000000/4000000.0)));

    // Send 8 data bits (LSB first)
    for (i = 0; i < 8; i++){
        LATAbits.LATA2 = (data >> i) & 0x01;
        _delay((unsigned long)(((1000000 / 9600) // in microseconds)*(2000000/4000000.0)));
    }

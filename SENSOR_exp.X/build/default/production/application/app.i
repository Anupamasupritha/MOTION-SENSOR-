...
# 2 "<built-in>" 2
# 1 "application/app.c" 2

# 1 "application/../service/sensor_service.h" 1




# 1 "C:\\Users\\Anurag\\.mcc\\pic\\include\\c99/stdbool.h" 1 3
# 6 "application/../service/sensor_service.h" 2

// Checks if the current lighting condition is dark
// Returns 1 if it's dark, false otherwise
_Bool IsDarkCondition(void);

// Detects whether motion is present
// Returns 1 if motion is detected by the PIR sensor, 0 otherwise
_Bool IsMotionDetected(void);
# 3 "application/app.c" 2
# 1 "application/../service/uart_service.h" 1
# 29 "application/../service/uart_service.h"
...
// Sends a single character over the UART communication link
void UART_SendChar(char ch);

// Sends a string of characters over the UART communication link
void UART_SendString(const char* str);
# 4 "application/app.c" 2
# 1 "application/../mcc_generated_files/mcc.h" 1
# 49 "application/../mcc_generated_files/mcc.h"
...
# 50 "application/../mcc_generated_files/mcc.h" 2
# 1 "application/../mcc_generated_files/device_config.h" 1
# 51 "application/../mcc_generated_files/mcc.h" 2
# 1 "application/../mcc_generated_files/pin_manager.h" 1
# 68 "application/../mcc_generated_files/pin_manager.h"
// get/set channel_AN0 aliases
# 88 "application/../mcc_generated_files/pin_manager.h"
// get/set channel_AN1 aliases
# 108 "application/../mcc_generated_files/pin_manager.h"
// get/set UART aliases
# 128 "application/../mcc_generated_files/pin_manager.h"
// get/set PIR aliases
# 148 "application/../mcc_generated_files/pin_manager.h"
// get/set LED aliases
# 175 "application/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 187 "application/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_IOC(void);
# 52 "application/../mcc_generated_files/mcc.h" 2
...
# 55 "application/../mcc_generated_files/mcc.h" 2
# 1 "application/../mcc_generated_files/interrupt_manager.h" 1
# 56 "application/../mcc_generated_files/mcc.h" 2
...
# 57 "application/../mcc_generated_files/mcc.h" 2
# 1 "application/../mcc_generated_files/tmr1.h" 1
# 63 "application/../mcc_generated_files/tmr1.h"
extern volatile _Bool MotionPresent;
# 101 "application/../mcc_generated_files/tmr1.h"
void TMR1_Initialize(void);
# 130 "application/../mcc_generated_files/tmr1.h"
void TMR1_StartTimer(void);
# 162 "application/../mcc_generated_files/tmr1.h"
void TMR1_StopTimer(void);
# 197 "application/../mcc_generated_files/tmr1.h"
uint16_t TMR1_ReadTimer(void);
# 236 "application/../mcc_generated_files/tmr1.h"
void TMR1_WriteTimer(uint16_t timerVal);
# 272 "application/../mcc_generated_files/tmr1.h"
void TMR1_Reload(void);
# 311 "application/../mcc_generated_files/tmr1.h"
void TMR1_StartSinglePulseAcquisition(void);
# 350 "application/../mcc_generated_files/tmr1.h"
uint8_t TMR1_CheckGateValueStatus(void);
# 368 "application/../mcc_generated_files/tmr1.h"
void TMR1_ISR(void);
# 386 "application/../mcc_generated_files/tmr1.h"
 void TMR1_SetInterruptHandler(void (* InterruptHandler)(void));
# 404 "application/../mcc_generated_files/tmr1.h"
extern void (*TMR1_InterruptHandler)(void);
# 422 "application/../mcc_generated_files/tmr1.h"
void TMR1_DefaultInterruptHandler(void);
# 58 "application/../mcc_generated_files/mcc.h" 2
# 1 "application/../mcc_generated_files/adc1.h" 1
# 72 "application/../mcc_generated_files/adc1.h"
...
# 95 "application/../mcc_generated_files/adc1.h"
typedef enum
{
    channel_AN0 = 0x0,
    channel_AN1 = 0x1,
...
# 137 "application/../mcc_generated_files/adc1.h"
void ADC1_Initialize(void);
# 167 "application/../mcc_generated_files/adc1.h"
void ADC1_SelectChannel(adc_channel_t channel);
# 194 "application/../mcc_generated_files/adc1.h"
void ADC1_StartConversion(void);
# 226 "application/../mcc_generated_files/adc1.h"
_Bool ADC1_IsConversionDone(void);
# 259 "application/../mcc_generated_files/adc1.h"
adc_result_t ADC1_GetConversionResult(void);
# 289 "application/../mcc_generated_files/adc1.h"
adc_result_t ADC1_GetConversion(adc_channel_t channel);
# 317 "application/../mcc_generated_files/adc1.h"
void ADC1_TemperatureAcquisitionDelay(void);
# 59 "application/../mcc_generated_files/mcc.h" 2
# 73 "application/../mcc_generated_files/mcc.h"
void SYSTEM_Initialize(void);
# 86 "application/../mcc_generated_files/mcc.h"
void OSCILLATOR_Initialize(void);
# 98 "application/../mcc_generated_files/mcc.h"
void WDT_Initialize(void);
# 5 "application/app.c" 2
# 1 "application/../application/app.h" 1



_Bool APP_Init(void); // Initializes the application components (LED, Timer, etc.)
void APP_Task(void); // Main application task (polling) that checks for motion and controls the LED
# 6 "application/app.c" 2
volatile _Bool MotionPresent = 0; // Flag to track whether motion is currently present

// Initializes application components
_Bool APP_Init(void) {
    UART_Init();
    TMR1_StopTimer(); // Stop timer initially
    do { TRISAbits.TRISA5 = 0; } while(0); // Configure LED pin as output
    do { ODCONAbits.ODA5 = 0; } while(0); // Set output driver to push-pull
    do { LATAbits.LATA5 = ~LATAbits.LATA5; } while(0); // Turn OFF LED initially
    return(1);
}
...
void APP_Task(void) {
    if (IsDarkCondition()) { // Check if it?s dark
        if(MotionPresent == 0) // If we haven't already recognized a motion event
        {
            if(IsMotionDetected()) // If motion is now detected by PIR sensor
            {
                TMR1_StartTimer();
                MotionPresent = 1; // Set to 1 to ignore further detections during this period
                do { LATAbits.LATA5 = 1; } while(0); // Turn ON LED to indicate motion

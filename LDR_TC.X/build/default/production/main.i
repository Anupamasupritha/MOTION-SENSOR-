...
# 2 "main.c" 2
# 1 "C:\\Users\\Anurag\\.mcc\\pic\\include\\c99/string.h" 1 3
# 25 "C:\\Users\\Anurag\\.mcc\\pic\\include\\c99/string.h" 3
# 1 "C:\\Users\\Anurag\\.mcc\\pic\\include\\c99/bits/alltypes.h" 1 3
# 421 "C:\\Users\\Anurag\\.mcc\\pic\\include\\c99/bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 26 "C:\\Users\\Anurag\\.mcc\\pic\\include\\c99/string.h" 2 3
...
_Bool ADC_Compare(uint16_t a, uint16_t b, uint8_t tol) {
...
void test_LDR_equal_light(void) {
    LDR1_Value = 500;
    LDR2_Value = 500;
    if (((ADC_Compare(LDR1_Value, LDR2_Value, 5)) ? 1 : 0)) {
...
void test_LDR_calibration_drift(void) {
    LDR1_Value = 350;
    LDR2_Value = 354;
    if (((ADC_Compare(LDR1_Value, LDR2_Value, 3)) ? 1 : 0)) {
...
void test_LDR_darkness_trigger_logic(void) {
    LDR1_Value = 850;
    LDR2_Value = 860;
    if ((LDR1_Value > 800) && (LDR2_Value > 800)) {
...
int main(void) {
    ...
    while (1) {
        ...
        switch (TestcaseSel) {
            ...
            default: UART_SendString(" wrong input\r"); (LATAbits.LATA2 = 0); break;
        }
    }
    return 0;
}

...
uint16_t ReadLDR1(void) {
    ADCON0bits.CHS = (unsigned char) 0;
...
uint16_t ReadLDR2(void) {
 ADCON0bits.CHS = (unsigned char) 1;
    ADCON0bits.GO_nDONE = 1;
    while (!ADCON0bits.GO_nDONE);
    return ((uint16_t)((ADRESH << 8) + ADRESL));
}
...
void evaluate_and_act(void) {
    if ((LDR1_Value > 800 && LDR2_Value > 800) && PIR_State) {
...
void test_INT_TC_11(void) {
    ...
    LDR2_Value = ReadLDR2();
    PIR_State = ReadPIR();
    PIR_State = 1; evaluate_and_act(); _delay((unsigned long)((500)*(4000000/4000.0)));

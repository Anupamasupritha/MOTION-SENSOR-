...
void test_PIR_toggle_motion_fast(void) {
    ...
    LATAbits.LATA0 = 1;
    CheckPIRSensor();
    res1 =(LATAbits.LATA2 == 1)? 1 : 0;
    TRISAbits.TRISA0 = 0;
    LATAbits.LATA0 = 0;
    TRISAbits.TRISA0 = 1;
    CheckPIRSensor();
    res2 = (LATAbits.LATA2 == 0)? 1 : 0;
    LATAbits.LATA0 = 1;
    CheckPIRSensor();
    res3 = (LATAbits.LATA2 == 1)? 1 : 0;
    if( res1 && res2 && res3)
...
void test_PIR_toggle_short_spike(void) {
    ...
    LATAbits.LATA0 = 0;
    CheckPIRSensor();
    res1 = (LATAbits.LATA2 == 0)? 1 : 0;
    TRISAbits.TRISA0 = 0;
    LATAbits.LATA0 = 1;
    TRISAbits.TRISA0 = 1;
    CheckPIRSensor();
    res2 = (LATAbits.LATA2 == 1)? 1 : 0;
    LATAbits.LATA0 = 0;
    CheckPIRSensor();
    res3 = (LATAbits.LATA2 == 0)? 1 : 0;
    if(res1 && res2 && res3)
